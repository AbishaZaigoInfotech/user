  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
		...
		$name = $session->get('name'); echo ucfirst($name); ?></a>
        </div>
      </div>
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <a href="<?= site_url('users/index')?>" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="<?= site_url('users/create')?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?= site_url('auth/changepassword')?>" class="nav-link">
